...
def archive_sweep(root: Path, *, enqueue: bool = False, actor: str = "system:archive") -> dict[str, Any]:
    ...
    report = {"ok": True, "id": new_id("archive_sweep"), "created_at": utc_now_iso(), "candidates": candidates, "jobs": jobs}
