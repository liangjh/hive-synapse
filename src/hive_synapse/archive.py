...
Module guide:
- `archive_sweep` finds inactive node/actor/archive candidates and can enqueue jobs.
...
def archive_sweep(
    root: Path, *, enqueue: bool | None = None, actor: str = "system:archive"
) -> dict[str, Any]:
        ...
        for candidate in candidates:
            jobs.append(
                enqueue_job(
                    ...
                    reason="archive sweep candidate",
                    actor=actor,
                )["job"]
            )
    report = {
